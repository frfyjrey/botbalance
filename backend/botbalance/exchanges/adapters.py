...
class ExchangeAdapter(ABC):
    ...
    def validate_order_params(self, *, symbol: str, side: str, limit_price: Decimal, quote_amount: Decimal) -> None:
        ...
        if quote_amount <= 0:
            raise InvalidOrderError(f"Invalid quote_amount: {quote_amount}. Must be > 0")
